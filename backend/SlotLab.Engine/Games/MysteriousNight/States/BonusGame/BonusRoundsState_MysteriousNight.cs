...
namespace SlotLab.Engine.Core
{
    ...
    /// </summary> 
    public class BonusRoundsState_MysteriousNight : BonusRoundsState
    {
        public BonusRoundsState_MysteriousNight(IGameStateMachine machine, GameEventBus gameEventBus) : base(machine, gameEventBus) { }
