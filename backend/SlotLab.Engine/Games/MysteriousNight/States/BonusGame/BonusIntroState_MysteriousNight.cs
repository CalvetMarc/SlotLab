...
namespace SlotLab.Engine.Core
{
    ...
    /// </summary> 
    public class BonusIntroState_MysteriousNight : BonusIntroState
    {
        public BonusIntroState_MysteriousNight(IGameStateMachine machine, GameEventBus gameEventBus) : base(machine, gameEventBus) { }
