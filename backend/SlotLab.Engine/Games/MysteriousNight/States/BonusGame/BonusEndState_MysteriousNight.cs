...
namespace SlotLab.Engine.Core
{
    ...
    /// </summary> 
    public class BonusEndState_MysteriousNight : BonusEndState
    {
        public BonusEndState_MysteriousNight(IGameStateMachine machine, GameEventBus gameEventBus) : base(machine, gameEventBus) { }
