...
namespace SlotLab.Engine.Core
{
    ...
    /// </summary> 
    public class BonusState_MysteriousNight : BonusState
    {
        public BonusState_MysteriousNight(IGameStateMachine machine, GameEventBus gameEventBus) : base(machine, gameEventBus) { }
